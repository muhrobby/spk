...
export function SendRankingEmailDialog({
  periode,
  rowsCount,
}: SendRankingEmailDialogProps) {
    ...
    >
      <DialogTrigger asChild>
        <Button
          ...
          size="sm"
          variant="secondary"
          disabled={rowsCount === 0 || isSubmitting}
        >
      ...
      <DialogContent className="max-w-[calc(100%-2rem)] sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Rangking yang sedang tampil akan di kirim ke email yang diinput
            dibawah
          </DialogDescription>
        </DialogHeader>
