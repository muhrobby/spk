      ...
      <Table>
        <TableHeader className="bg-muted/30">
          <TableRow>
            ...
            <TableHead className="text-center">Achv Penjualan</TableHead>
            <TableHead className="text-center">SLA Ontime</TableHead>
          ...
          {rows.map((row) => (
            <TableRow key={row.storeId}>
              ...
              <TableCell className="text-right">
                <Badge className={getScoreBadgeClass(row.nilaiAkhir)}>
